...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div class="btn-group btn-group-sm" role="group">
      <a href="{{ route('proveedores.edit',$proveedor->IdProveedor) }}" class="btn btn-primary"><i class="far fa-edit mr-1"></i> Editar</a>
      <a href="{{ route('proveedores.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left mr-1"></i> Volver</a>
    </div>
  </div>
  <div class="card-body">
    <dl class="row mb-0">
